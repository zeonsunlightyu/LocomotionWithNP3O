...
private:
    ...
    void StartSendCmd()
    {
        std::cout << "start sending command" << std::endl;
   ...
   void UpdateStateMachine()
    ...
    void StandCallback()
    {
        ...
        robot_interface.kp.fill(40);
        robot_interface.kd.fill(1);
...
//        for (int j = 0; j < 12; j++)
//        {
//            robot_interface.jpos_des.at(j) = (1 - state_machine.pd_ratio) * robot_interface.jpos[j] + state_machine.pd_ratio * ctrl.init_pos[j];
//
//        }
