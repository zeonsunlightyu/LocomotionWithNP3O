...
class ActorCriticRmaTrans(nn.Module):
    ...
    def __init__(self,  num_prop,
        ...
        self.actor_teacher_backbone = nn.Sequential(*actor_teacher_layers)
        config = Config()
        self.actor_student_backbone = ActionCausalTransformer(config)
    ...
    def imitation_learning_loss(self, obs):
        ...
        loss = F.mse_loss(mean,target_mean)
        return loss

class ActorCriticPureTrans(nn.Module):
    is_recurrent = False
    def __init__(self,  num_prop,
                        num_scan,
                        num_critic_obs,
                        ...
                        init_noise_std=1.0,
                        **kwargs):
        super(ActorCriticPureTrans, self).__init__()
